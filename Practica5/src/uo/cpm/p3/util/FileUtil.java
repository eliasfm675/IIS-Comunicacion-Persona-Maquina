...
public static void loadFile (String fileName, List<Product> productsList) {
	...
	try {
		        ...
		        sb.append("Cliente: " + order.getCustomer().getName() +"\n");
		        sb.append("--------------------------------------------------------\n");
		        for(Product a: order.getOrderList()) {
		        	sb.append(a.toString()+"\n");
		        }
		        sb.append("Total: " + order.getPrice()+"\n");
		        if(order.isTakeAway()) {
		        	sb.append("Pedido para llevar");
		        }else {
		        	sb.append("Pedido para consumir en el local");
		        }
